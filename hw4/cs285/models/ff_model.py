...
class FFModel(nn.Module, BaseModel):
    ...
    def get_prediction(self, obs, acs, data_statistics):
        ...
        prediction = self(obs, acs, self.obs_mean, self.obs_std, self.acs_mean, self.acs_std,
    ...
    def update(self, observations, actions, next_observations, data_statistics):
        ...
        preds = self(observations, actions, self.obs_mean, self.obs_std, self.acs_mean, self.acs_std,
