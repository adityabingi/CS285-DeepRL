    ...
    def __init__(self,
        ...
        if self.discrete:
            ...
            self.optimizer = optim.Adam(
                itertools.chain(self.common.parameters(), self.mean.parameters(), self.logstd.parameters()),
                self.learning_rate
            )
...
class SAC_Alpha_Policy(MLPPolicy):
    ...
    def policy_parameters(self):
        ...
        return itertools.chain(self.common.parameters(), self.mean.parameters(), self.logstd.parameters())
    ...
    def actions_and_logprobs(self, observations: torch.FloatTensor, eps=1e-6):
        ...
        if self.discrete:
            ...
            log_probs -= torch.log(self.action_scale * (1.0-squash_actions.pow(2))+ eps)
