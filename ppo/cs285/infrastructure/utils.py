...
def sample_trajectory(env, policy, max_path_length, render=False, render_mode=('rgb_array')):
    ...
    # init vars
    obs, acs, rewards, next_obs, terminals, logprobs, image_obs = [], [], [], [], [], [], []
    steps = 0
    while True:
        ...
        logprob = ptu.to_numpy(policy.logprobs(ob, ac))
    ...
    return Path(obs, image_obs, acs, rewards, next_obs, terminals, logprobs)
...
def Path(obs, image_obs, acs, rewards, next_obs, terminals, logprobs):
    """
...
def convert_listofrollouts(paths):
    ...
    logprobs = np.concatenate([path["logprobs"] for path in paths])
    return observations, actions, next_observations, terminals,concatenated_rewards, unconcatenated_rewards, logprobs
